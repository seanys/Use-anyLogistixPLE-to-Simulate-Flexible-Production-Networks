...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image002.png)
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image004.png)
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image005.png)
...
即每个DC对应K个有固定需求分布如 ![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image007.png)的Customers的情况下，需要达到一定的服务水平（Identical Service Level Requirements），如何指定每个DC对应的K个Customer，能够使得![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image009.png)的值最小。

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image010.png)

  在设定客户需求均满足独立同分布 ![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image012.png)，目标服务水平为0.99，即每天客户需求有99%的概率可以送到，对应不同的客户数目N（N=4,8,12,16,20）时，K-Chain Network的最低配送能力水平如下图。**我们可以看到，1-Chain Network（K=1）即选择Dedicated Network时，最佳配送分配（Optimal Capacity Profiles）所需要的配送总能力（Total Capacity Level），远远大于K>1的情况，而其实只需要达到K=2，就与Full-Flexibility Network的效果一致。**

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image013.png)

### 2.2 实验方法

  我们将使用ALX的SIM模块先建立有![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image015.png)个有固定的配送能力![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image017.png)的配送中心DC，每个DC周边有10个需求满足独立同分布![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image019.png)的Customers，建立不同的K-Chain Network（K=1,2,N），比较其在不同的![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image021.png)比如正态分布、均匀分布情况下，能够实现的服务水平和所需要的运输费用。
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image022.png)
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image023.png)

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image024.png)
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image025.png)
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image026.png)
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image027.png)

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image028.png)
...
不过我们可以注意到，如果只考虑10个中的8个Customer，能否实现100%的服务水平呢？事实上是可以的，下图便是采用 ![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image030.png) 且每日订货量为950时的服务水平，只服务八个客户可以满足全部订单。

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image031.png)
...
同样采用Long-Chain进行说明，即从每个区域对应的多个末端配送中心中抽取出N个Customer作为Final Group N，其他作为Group N。每个DC最初只服务Group N，上述试验结果表示服务水平在一定范围内为100%，然后Final Group中的末端配送中心由两个DC服务，从中选择库存更大的那一个服务即可。

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image026.png)  

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image032.png)

**两图能够实现的效果基本上是一致的**

  最终，我们在ALX中的设置如下：

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image033.png)
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image038.png)
  ...
  **需求方面**：每天早上2点Group N Customer发出周期性请求，其符合目标的分布函数![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image021.png)，Lead Time设定为6小时，由于新加坡较小，只要有足够库存，六小时肯定能够送到货；每天上午8点开始分配剩余的快递，按照上一节介绍的时间安排，发出固定的需求，货物将在三小时内配送到位，所以Lead Time设置为3小时。
...
![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image044.png)
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image047.png)
...
| -------- | ------------------------------------------------------------ | ------------ | -------- |
| 具体选择 | ![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image049.png)  ![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image051.png)  ![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image053.png) | {950}        | {0,1,2}  |

每个DC共对应10个Customers，为了使得试验结果中的服务水平参数明显，供给能力设置的略小于需求的期望值，正态分布和均匀分布的期望值均为![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image055.png)，需求设置得比100*10=1000要稍小，这里我们统一设置为950。

### 4.3 统计函数配置

  **服务水平**：分别对Dayily和Accumulate进行比较，查看每个DC能够到的Service Level by Order.

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image056.png)

  **运输费用**：限制对象为6个DC，限制目的地Group Customer或者Final Customer，排除Supplier到DC以及DC到Controllers的运输费用。

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image057.png)

## 5.实验结果

### 5.1 均匀分布

  我们对几个均匀分布进行重复试验，试验结果如下。**当需求的水平的变化范围较小时，即取**![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image059.png)**，三种模式的差异并不大**，均为91.5%上下；**随着其随着变化范围的增加，Long-Chain Mechanism与Pooling Mechanism的服务水平几乎没有下降（出现上升应该是由于试验次数不够），Dedicated Mechanism的服务水平逐渐下降**，并与前两种机制的服务水平差距逐渐拉大。



**不同需求分布服务水平统计**

  该试验结果基本符合预期，即服务水平Pooling Mechanism ![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image067.png) Long-Chain Mechanism >> Dedicated Mechanism。我们对![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image061.png)的试验结果进行进一步分析，每轮的具体的服务水平变化以及服务水平和交通费用如下。



![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image061.png)**服务水平统计**
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image061.png)**交通费用统**

![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image071.png)

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image073.png)**Dedicated Mechanism**



![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image074.png)

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image061.png)**Long Chain Mechanism**



![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image076.png)

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image078.png)**Pooling Mechanism**



**服务水平**：Pooling Mechanism ![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image067.png) Long-Chain Mechanism >> Dedicated Mechanism，且Pooling Mechanism与Long-Chain几乎无差异。
...
**不同需求分布服务水平统计**
  ...
  我们选择实现效果比较好的需求分布![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image087.png)进一步分析，服务水平的实时统计以及服务水平和花费的数据如下。
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image089.png)**时服务水平统计**
...
![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image089.png)**时交通费用统计**

![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image091.png)

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image093.png)**Dedicated Mechanism**

![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image094.png)

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image093.png)**Long Chain Mechanism**

![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image096.png)

![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image093.png)**Pooling Mechanism**



**查看综合统计结果，可以得到一样的结论。**

**服务水平**：Pooling Mechanism ![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image067.png) Long-Chain Mechanism >> Dedicated Mechanism，且Pooling Mechanism与Long-Chain几乎无差异。
...
### 5.3 结果分析
  ...
  我们可以看到，不管是采用正态分布还是采用均匀分布，服务水平基本上满足Pooling ![img](/Users/sean/Documents/Projects/My Github/Use-anyLogistixPLE-to-Simulate-Flexible-Production-Networks/img/clip_image100.png) Long-Chain > Dedicated。
...
在正态分布和均匀分布需求的变化范围较小时，三种分配机制的差异并不明显，随着需求变化范围的扩大（方差增加），Pooling与Long-Chain两种机制几乎没有变化，但是Dedicated却开始下降，该结果符合论文的实验预期，即Long-Chain于Pooling的服务水平类似并高于Dedicated。
  ...
  我们也可以用一个单向链来解释，第一个DC供应能力不足，可以由第二个DC供应，但是也导致了第二个DC不足，由第三个DC补充供应能力，但是实际的情况是双向的，效果会比单向更好。偶尔也可能出现无法满足需求，导致无法传导供应能力，所以一般来说Long-Chain的服务水平会Pooling耕地。

![img](file:////Users/sean/Library/Group%20Containers/UBF8T346G9.Office/TemporaryItems/msohtmlclip/clip_image101.png)
